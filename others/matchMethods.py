...
# -*- coding: utf-8 -*-
'''
Created on Mon Jul 29 15:23:30 2019
...
def runAllImageSimilaryFun(para1, para2):
    ...
    print(u'均值哈希算法相似度aHash：', n1)
 
    hash1 = dHash(img1)
    hash2 = dHash(img2)
    n2 = cmpHash(hash1, hash2)
    print(unicode('差值哈希算法相似度dHash：', encoding="utf-8"), n2)
 
    hash1 = pHash(img1)
    hash2 = pHash(img2)
    n3 = cmpHash(hash1, hash2)
    print(u'感知哈希算法相似度pHash：', n3)
 
    n4 = classify_hist_with_split(img1, img2)
    print(u'三直方图算法相似度：', n4)
...
if __name__ == '__main__':
    p1 = '/home/yangna/yangna/project/mclz/video_bk/yangna.jpg'
    p2 = '/home/yangna/yangna/project/mclz/video_bk/yangna_1.jpg'
